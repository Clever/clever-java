...
public class EventsApi {
    ...
    public com.squareup.okhttp.Call getEventsCall(Integer limit, String startingAfter, String endingBefore, String school, List<String> recordType, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (school != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("school", school));
        if (recordType != null)
        localVarCollectionQueryParams.addAll(apiClient.parameterToPairs("multi", "record_type", recordType));
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public EventsResponse getEvents(Integer limit, String startingAfter, String endingBefore, String school, List<String> recordType) throws ApiException {
        ApiResponse<EventsResponse> resp = getEventsWithHttpInfo(limit, startingAfter, endingBefore, school, recordType);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<EventsResponse> getEventsWithHttpInfo(Integer limit, String startingAfter, String endingBefore, String school, List<String> recordType) throws ApiException {
        com.squareup.okhttp.Call call = getEventsValidateBeforeCall(limit, startingAfter, endingBefore, school, recordType, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getEventsAsync(Integer limit, String startingAfter, String endingBefore, String school, List<String> recordType, final ApiCallback<EventsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getEventsValidateBeforeCall(limit, startingAfter, endingBefore, school, recordType, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<EventsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
